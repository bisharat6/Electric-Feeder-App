  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      mainAxisAlignment: MainAxisAlignment.start,
        children: [
          CustomBar(back:(){Get.to(HomeScreen());}, not:(){Get.to(ScheduledFeederScreen());},show: true,),
          SizedBox(height: Get.height*0.01,),
          Center(child: Text("Feeder Details",style: TextStyle(
            color: Colors.black,
            fontSize: 30,
          ...
          BoxShadow(
            ...
            offset: Offset(0, 3), // Offset from the top-left corner
              ...
              child: Column(
                ...
                children: [
                    SizedBox(height: Get.height*0.01,),
          Center(child: Text("Feeder 001",style: TextStyle(
            color: Colors.black,
            fontSize: 20,
            fontWeight: FontWeight.w700
            ),)),
            Row(
              ...
              children: [
                Icon(Icons.wifi,size: 45,color: AppColors.primaryclr,),
                Transform.rotate(
                angle: 1.55,
                  child: Icon(Icons.battery_full_outlined,size: 50,color: AppColors.primaryclr)),
                  Icon(Icons.calendar_month,size: 45,color: AppColors.primaryclr),
                  Icon(Icons.arrow_forward_ios,size: 35,color: AppColors.primaryclr)
              ...
              onTap: (){
               ...
               child: Container(
                ...
                child: Column(
                  ...
                  children: [
                      SizedBox(height: Get.height*0.01,),
                         Center(child: Text("Feeder 002",style: TextStyle(
                           color: Colors.black,
                           fontSize: 20,
                           fontWeight: FontWeight.w700
                           ),)),
              ...
              onTap: (){
               ...
               child: Container(
                ...
                child: Column(
                  ...
                  children: [
                      SizedBox(height: Get.height*0.01,),
                         Center(child: Text("Feeder 003",style: TextStyle(
                           color: Colors.black,
                           fontSize: 20,
                           fontWeight: FontWeight.w700
                           ),)),
          ...
          BoxShadow(
            ...
            offset: Offset(0, 3), // Offset from the top-left corner
              ...
              child: Column(
                ...
                children: [
                    SizedBox(height: Get.height*0.01,),
          Center(child: Text("Feeder 004",style: TextStyle(
            color: Colors.black,
            fontSize: 20,
            fontWeight: FontWeight.w700
            ),)),
